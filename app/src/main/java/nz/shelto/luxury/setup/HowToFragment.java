package nz.shelto.luxury.setup;
...
public class HowToFragment extends CustomFragment {
    ...
    public HowToFragment(Activity parentActivity) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this.getContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions((Activity)this.getContext(), new String[]{Manifest.permission.CAMERA}, 1);
            return;
        }
    }
